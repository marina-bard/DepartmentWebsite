...
use DepartmentSite\MenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $menus = $em->getRepository('DepartmentSiteMenuBundle:Menu')->findAll();
    ...
    {
        $menu = new Menu();
        $form = $this->createForm('DepartmentSite\MenuBundle\Form\MenuType', $menu);
    ...
    {
        $deleteForm = $this->createDeleteForm($menu);
        $editForm = $this->createForm('DepartmentSite\MenuBundle\Form\MenuType', $menu);
