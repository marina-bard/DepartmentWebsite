...
class ProfileStudentUserFormType extends AbstractType
{
    private $class;
    ...
    {
        $this->class = 'Application\FOS\UserBundle\Entity\StudentUser';
    }
    ...
    {
        return 'fos_user_profile_form_student_user';
    }
    ...
    protected function buildUserForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('studyGroup', null, array('label' => 'form.studyGroup', 'translation_domain' => 'FOSUserBundle'))
        ;
    }
}